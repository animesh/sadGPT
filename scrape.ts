import { SadGChunk, SadGEssay, SadGJSON } from "@/types";
...
const chunkEssay = async (essay: SadGEssay) => {
  ...
  const chunkedSection: SadGEssay = {
    ...essay,
    chunks: essayChunks
  };
...
(async () => {
  ...
  fs.writeFileSync("scripts/SadG.json", JSON.stringify(json));
})();
